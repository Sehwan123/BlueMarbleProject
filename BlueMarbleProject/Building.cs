    ...
    public partial class Building : Form
    {
        ...
        private void btnOK_Click(object sender, EventArgs e)
        {
            ...
            if (Villa.Checked) // 빌라 선택시
            {
                ...
                // 건물 사진 넣기
                MainBoard.Build[buildIndex].Image = Build1.Image;
            ...
            else if (Apart.Checked) // 빌딩 선택시
            {
                ...
                // 건물 사진 넣기
                MainBoard.Build[buildIndex].Image = Build2.Image;
                MainBoard.Build[buildIndex].Visible = true;
            }
            else if (Hotel.Checked) // 호텔 선택시
            {
                ...
                // 건물 사진 넣기
                MainBoard.Build[buildIndex].Image = Build3.Image;
                MainBoard.Build[buildIndex].Visible = true;
            }
            else if (Randmark.Checked) // 랜드마크 선택시
            {
                ...
                // 건물 사진 넣기
                MainBoard.Build[buildIndex].Image = Build4.Image;
                MainBoard.Build[buildIndex].Visible = true;
            }
